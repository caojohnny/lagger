...
public class SkullCompat19R01 implements SkullCompat {
    @Override
    ...
    public void ensureSkullTextures(Inventory inv, int slot) {
        ...
        net.minecraft.server.v1_9_R1.ItemStack item = iinv.getItem(slot);
    ...
    private static void updateSlot(Inventory inventory, int slot, net.minecraft.server.v1_9_R1.ItemStack item) {

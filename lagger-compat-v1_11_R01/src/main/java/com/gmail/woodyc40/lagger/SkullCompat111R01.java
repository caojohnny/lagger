...
public class SkullCompat111R01 implements SkullCompat {
    @Override
    ...
    public void ensureSkullTextures(Inventory inv, int slot) {
        ...
        net.minecraft.server.v1_11_R1.ItemStack item = requireNonNull(iinv.getItem(slot));
    ...
    private static void updateSlot(Inventory inventory, int slot, net.minecraft.server.v1_11_R1.ItemStack item) {
